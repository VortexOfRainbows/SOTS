...
namespace SOTS.Helpers
{
    public static class ColorHelper
    {
        ...
        public static Color SandstormPouchColor => new Color(179, 143, 97);
        ...
        public static Color InfernoColorGradient(float lerp)
        {
            return Color.Lerp(Inferno1, Inferno2, lerp);
        }
        public static Color ShrimpColorGradient(float lerp)
        {
            return Color.Lerp(new Color(165, 68, 68), TideColor, lerp);
        }
        public static Color InfernoColorGradientDegrees(float degrees)
        {
            return InfernoColorGradient(0.5f * MathF.Sin(MathHelper.ToRadians(SoulColorCounter * 3f + degrees)));
        }
        public static Color VibrantColorGradient(float degrees, bool avoidColorCycling = false)
        {
