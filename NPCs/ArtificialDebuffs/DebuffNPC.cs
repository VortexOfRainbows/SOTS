...
namespace SOTS.NPCs.ArtificialDebuffs
{
    public class DebuffNPC : GlobalNPC
    {
        ...
        public static void LoadArrays()
        {
            ...
            spirits = new int[] { NPCType<Constructs.NatureSpirit>(), NPCType<Constructs.EarthenSpirit>(), NPCType<Constructs.PermafrostSpirit>(), NPCType<Constructs.TidalSpirit>(), NPCType<EvilSpirit>(), NPCType<Constructs.InfernoSpirit>(), NPCType<Constructs.ChaosSpirit>(), NPCType<Lux>() };
