...
{
	public class FrightKnight : ModNPC
	{	int velocityDown = 0;
	int boom = 0;
	int hurt = 0;
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault("Fright Knight");
		}
		...
		public override void NPCLoot()
		{
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, (mod.ItemType("FrightHopper")), 1);	
		...
		public override void AI()
		{
			...
			{
				boom = 0;
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0, 0, 292, 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0, -9, mod.ProjectileType("FrightLava"), 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 3, -8, mod.ProjectileType("FrightLava"), 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, -3, -8, mod.ProjectileType("FrightLava"), 83, 1, 0);
