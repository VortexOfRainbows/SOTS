...
{
	public class SightKnight : ModNPC
	{	int velocityDown = 0;
	int boom = 0;
	int hurt = 0;
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault("Sight Knight");
		}
		...
		public override void NPCLoot()
		{
			...
			Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, (mod.ItemType("SightCrash")), 1);
		...
		public override void AI()
		{
			...
			{
				boom = 0;
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0, -9, mod.ProjectileType("SightHoney"), 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 3, -8, mod.ProjectileType("SightHoney"), 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, -3, -8, mod.ProjectileType("SightHoney"), 83, 1, 0);
				Projectile.NewProjectile(npc.Center.X, npc.Center.Y, 0, 0, mod.ProjectileType("SightHealHostile"), 1, 1, 0);
