...
{    
    public class PutridPinky2Tail : ModNPC
    {	int ai1 = 0;
		int ai2 = 0;
		...
		public override void PostAI()
		{
			...
			{
			Projectile.NewProjectile(npc.Center.X, npc.Center.Y, Main.rand.Next(-10,9), Main.rand.Next(-10,9), mod.ProjectileType("PinkBullet"), 40, 0f, 0);
			}
			npc.timeLeft = 6;
		}
    }
