...
{
	public class CodeDust2 : ModDust
	{
        ...
        {
            return new Color(200, 200, 255, dust.alpha);
		}
        ...
        public override bool Update(Dust dust)
		{
			...
			dust.alpha += 5;
			float strength = 1f;
			Lighting.AddLight(dust.position, 0.45f * strength * ((255 - dust.alpha) / 255f), 0.55f * strength * ((255 - dust.alpha) / 255f), 0.75f * strength * ((255 - dust.alpha) / 255f));
