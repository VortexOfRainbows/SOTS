...
{    
    ...
    {	
		...
		private int chargeTime = 160; //charge time in frames
		private int explosiveCountMin = 3; //amount of explosions minimum
		private int explosiveCountMax = 5; //amount of explosions max
		private float explosiveRange = 70; //distance between each explosion
		private float releaseTime = 150; //how long in frames until auto-release
