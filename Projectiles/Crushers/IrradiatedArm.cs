...
{    
    ...
    {	
		...
		private float maxDamage = 9; //total damage %, 1 for no increase, 5 for 500% at max charge, etc
		private int chargeTime = 110; //charge time in frames
		private int explosiveCountMin = 1; //amount of explosions minimum
		private int explosiveCountMax = 9; //amount of explosions max
		private float explosiveRange = 48; //distance between each explosion
		private float releaseTime = 40; //how long in frames until auto-release
