...
{    
    public class HellbreakerArm : ModProjectile 
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Hellbreaker Arm");
		...
		private float maxDamage = 6; //total damage %, 1 for no increase, 5 for 500% at max charge, etc
		private int chargeTime = 190; //charge time in frames
		...
		private float releaseTime = 240; //how long in frames until auto-release
		...
		public override void AI()
		{
			...
			{
				int num1 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, 6);
