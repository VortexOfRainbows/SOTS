...
{    
    ...
    {	float distance = 30f;  
		...
		public override void AI()
		{
			...
			int num1 = Dust.NewDust(new Vector2(projectile.Center.X + circularLocation.X - 4, projectile.Center.Y + circularLocation.Y - 4), 4, 4, 60);
		...
		public override void Kill(int timeLeft)
		{
			...
			if(projectile.owner == Main.myPlayer)
			{
				...
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("HealProj"), 0, 0, player.whoAmI, (int)projectile.ai[0] + heal, 1);
			}
			for(int i = 5; i > 0; i --)
			{
