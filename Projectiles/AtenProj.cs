    ...
    {	
		...
		public override void AI()
		{
			...
			{	
				...
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X * 2f, projectile.velocity.Y * 2f, 12, projectile.damage, projectile.knockBack * 0.7f, player.whoAmI);
			}
		}
    }
}