...
{    
    public class DNA3Leader : ModProjectile 
    {	int worm = 0;
		int wait = 1;         
		...
		public override void AI()
		{
			...
			int num1 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), 10, 10, 72);
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("DNA3Follow"), projectile.damage, 0, 0);
