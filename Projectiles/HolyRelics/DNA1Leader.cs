...
{    
    public class DNA1Leader : ModProjectile 
    {	int worm = 0;
		int wait = 1;         
		...
		public override void AI()
		{
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("DNA1Follow"), projectile.damage, 0, 0);
