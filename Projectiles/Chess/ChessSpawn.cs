...
{    
    public class ChessSpawn : ModProjectile 
    {	int wait = 0;
		...
		public override void Kill(int timeLeft)
		{
				 ...
				 NPC.NewNPC((int)projectile.Center.X - 60, (int)projectile.Center.Y -40, mod.NPCType("ChessPortal"));	
				 NPC.NewNPC((int)projectile.Center.X - 600, (int)projectile.Center.Y -120, mod.NPCType("King"));	
		}
