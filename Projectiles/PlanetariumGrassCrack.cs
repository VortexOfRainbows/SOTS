...
{    
    public class PlanetariumGrassCrack : ModProjectile 
    {	int wait = 0;
		...
		public override void AI()
        {
			...
			int xPosition = (int)(projectile.Center.X / 16.0f);
                    int yPosition = (int)(projectile.Center.Y / 16.0f);
						...
						WorldGen.PlaceTile(xPosition, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition -1, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition +1, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition -2, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition +2, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition -3, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition +3, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition -4, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition +4, yPosition - 2, 0);
						WorldGen.PlaceTile(xPosition, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition -1, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition +1, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition -2, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition +2, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition -3, yPosition - 3, 0);
						WorldGen.PlaceTile(xPosition +3, yPosition - 3, 0);
						
						WorldGen.PlaceTile(xPosition, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition -1, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition +1, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition -2, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition +2, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition -3, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition +3, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition -4, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition +4, yPosition - 2, 2);
						WorldGen.PlaceTile(xPosition, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition -1, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition +1, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition -2, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition +2, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition -3, yPosition - 3, 2);
						WorldGen.PlaceTile(xPosition +3, yPosition - 3, 2);
