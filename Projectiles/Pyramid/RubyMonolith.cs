...
namespace SOTS.Projectiles.Pyramid
{
	public class RubyMonolith : ModProjectile
	{
		...
		public override void PostDraw(Color lightColor)
		{
			...
			Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, frame, lightColor, Projectile.rotation, drawOrigin, Projectile.scale, Projectile.spriteDirection == -1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
			if (shader != 0)
			{
		...
		public override void AI()
		{
            ...
            {
				SOTSUtils.PlaySound(SoundID.Item4, (int)Projectile.Center.X, (int)Projectile.Center.Y, 0.9f, 0.2f);
				for (int i = 0; i < 30; i++)
				{
