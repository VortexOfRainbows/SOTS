...
{    
    public class PyrocideSlash : ModProjectile //, IPixellated
    {
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), previousPosition, center, 48f * scale, ref point))
			{
				return true;
			}
			return false;
		...
		public void Draw(SpriteBatch spriteBatch)
        {
			...
			Texture2D texture2 = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Temple/PyrocideScale");
