...
namespace SOTS.Projectiles.Planetarium
{
	public class SpiralDeathBeam : ModProjectile
	{
		...
		{
			int maxDist = 200;
			Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/SpiralDeathBeam");
			Texture2D texture2 = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/SpiralDeathBeamEnd");
			bool dust = false;
