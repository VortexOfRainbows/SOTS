...
namespace SOTS.Projectiles.Planetarium
{
	public class DoubleLaser : ModProjectile
	{
		...
		{
			Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/DoubleLaser");
			Texture2D texture2 = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/DoubleLaserEnd");
			bool dust = false;
