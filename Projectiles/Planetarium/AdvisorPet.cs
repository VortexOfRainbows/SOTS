...
{    
    public class AdvisorPet : ModProjectile
    {
		...
		{
			Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/AdvisorPetSpirit");
        ...
        public override void PostDraw(Color lightColor)
        {
			...
			Texture2D texture2 = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/AdvisorPetHighlight");
