...
namespace SOTS.Projectiles.Planetarium
{
	...
	public class StarcoreRifle : ModProjectile
	{
		...
		{
			Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/StarcoreRifleEffect");
            ...
            texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/StarcoreRifleEffect2");
            for (int k = 0; k < 2; k++)
            ...
            texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/StarcoreRifleEffect3");
            for (int k = 0; k < 2; k++)
            ...
            color = Color.White;
            texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/StarcoreRifleGlow");
            Main.spriteBatch.Draw(texture, drawPos, null, color, Projectile.rotation, drawOrigin, Projectile.scale, Projectile.direction != 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
        }
