...
namespace SOTS.Projectiles.Planetarium
{
    public class InfernoHook : ModProjectile
    {
        ...
        {
            Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/InfernoHookChain");    //this where the chain of grappling hook is drawn
