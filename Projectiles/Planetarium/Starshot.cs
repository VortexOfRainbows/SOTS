...
namespace SOTS.Projectiles.Planetarium
{
    public class Starshot : ModProjectile
    {
        ...
        {
            Texture2D texture = (Texture2D)ModContent.Request<Texture2D>("SOTS/Projectiles/Planetarium/Starshot");
        ...
        {
            Texture2D texture = Mod.Assets.Request<Texture2D>("Projectiles/Planetarium/StarshotTrail").Value;
            Texture2D texture2 = Mod.Assets.Request<Texture2D>("Projectiles/Planetarium/Starshot").Value;
