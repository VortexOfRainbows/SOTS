...
{    
    public class SilverPunch : ModProjectile 
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Silver Fist");
		...
		{ 
			Lighting.AddLight(projectile.Center, (255 - projectile.alpha) * 2.5f / 255f, (255 - projectile.alpha) * 2.5f / 255f, (255 - projectile.alpha) * 2.5f / 255f);
			...
			if (Main.rand.NextBool(2))
			{
				...
				dust.noGravity = true;
				dust.fadeIn = 0.2f;
				dust.color = new Color(160, 170, 190, 0);
				dust.alpha = 100;
			}
		}
