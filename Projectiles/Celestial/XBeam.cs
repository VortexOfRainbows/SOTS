...
{    
    public class XBeam : ModProjectile 
    {	int timer = 0;
		...
		{
			Lighting.AddLight(projectile.Center, (255 - projectile.alpha) * 2.5f / 355f, (255 - projectile.alpha) * 1.6f / 355f, (255 - projectile.alpha) * 2.4f / 355f);
			timer++;
			if(timer <= 35)
			{
