...
{    
    public class PurpleArrow : ModProjectile 
    {	
		...
		{ 
			Lighting.AddLight(projectile.Center, (255 - projectile.alpha) * 2.5f / 555f, (255 - projectile.alpha) * 1.6f / 555f, (255 - projectile.alpha) * 2.4f / 555f);
