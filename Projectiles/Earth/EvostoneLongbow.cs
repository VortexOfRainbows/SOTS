...
{
    public class EvostoneLongbow : ModProjectile
    {
        ...
        const int fireFromDist = 34;
        const int fireFromTighten = 14;
        ...
        public override bool PreAI()
        {
            ...
            else if(runOnce)
            {
                ...
                if (Projectile.owner == Main.myPlayer)
                {
                    ...
                    Projectile proj = Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), fireFrom, Projectile.velocity * 1.6f, (int)Projectile.ai[1], Projectile.damage, Projectile.knockBack, Main.myPlayer);
                    proj.GetGlobalProjectile<SOTSProjectile>().affixID = -5; //this sould sync automatically on the SOTSProjectile end
                }
            }
