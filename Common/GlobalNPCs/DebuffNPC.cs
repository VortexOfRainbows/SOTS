...
namespace SOTS.Common.GlobalNPCs
{
    public class DebuffNPC : GlobalNPC
    {
        ...
        public static void LoadArrays()
        {
            ...
            Constructs = [NPCType<NatureConstruct>(), NPCType<EarthenConstruct>(), NPCType<PermafrostConstruct>(), NPCType<OtherworldlyConstructHead>(), 
                NPCType<TidalConstruct>(), NPCType<InfernoConstruct>(), NPCType<EvilConstruct>(), NPCType<ChaosConstruct>(), NPCType<Bridgeburner>()];
            ...
            intimidating = [ NPCType<NatureConstruct>(), NPCType<EarthenConstruct>(), NPCType<PermafrostConstruct>(), NPCType<OtherworldlyConstructHead>(), NPCType<TidalConstruct>(), NPCType<EvilConstruct>(), NPCType<InfernoConstruct>(), NPCType<ChaosConstruct>(), NPCType<Bridgeburner>(),
                NPCType<PutridPinkyPhase2>(), NPCType<NPCs.Boss.Curse.PharaohsCurse>(), NPCType<TheAdvisorHead>(), NPCType<NewPolaris>(), NPCType<Polaris>(), NPCType<SubspaceSerpentHead>(), NPCType<NPCs.Boss.Glowmoth.Glowmoth>(), NPCType<NPCs.Boss.Excavator.Excavator>()];
