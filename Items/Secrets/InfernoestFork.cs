...
{
	public class InfernoestFork : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Infernoest Fork");
		}
		public override void SetDefaults()
		{
            item.damage = 170;  //gun damage
            item.magic = true;   //its a gun so set this to true
            item.width = 72;     //gun image width
            item.height = 72;   //gun image  height
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "InfernoerFork", 3);
