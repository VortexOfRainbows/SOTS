...
namespace SOTS.Items.Fragments
{
    ...
    public class ChaosPlatingWall : ModItem
    {
        public override void SetStaticDefaults() => this.SetResearchCost(400);
        public override void SetDefaults()
        {
            ...
            Item.height = 28;
            Item.rare = ItemRarityID.Blue;
            Item.createWall = ModContent.WallType<ChaosPlatingWallWall>();
        }
        public override void AddRecipes()
        {
            CreateRecipe(4).AddIngredient<ChaosPlating>(1).AddTile(TileID.WorkBenches).Register();
            Recipe.Create(ModContent.ItemType<ChaosPlating>()).AddIngredient(this, 4).AddTile(TileID.WorkBenches).Register();
        }
    }
    public class ChaosPlatingWallWall : ModWall
    {
        public override void SetStaticDefaults()
        {
            Main.wallHouse[Type] = true;
            DustType = DustID.Platinum;
            AddMapEntry(Color.Lerp(SOTSTile.ChaosPlatingColor, Color.Black, 0.2f));
        }
    }
}