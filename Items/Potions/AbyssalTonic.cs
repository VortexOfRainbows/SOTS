...
{
	public class AbyssalTonic : ModItem
	{
		...
		public override bool? UseItem(Player player)
		{
			...
			int type1 = -1;
			int type2 = -1;
			int buff1 = BuffID.Gills;
			int buff2 = ModContent.BuffType<RippleBuff>();
			int buff3 = BuffID.Flipper;
			int buff4 = BuffID.Calm;
		...
		{
			CreateRecipe(1).AddIngredient(null, "DissolvingDeluge", 1).Register();
		}
	}
}