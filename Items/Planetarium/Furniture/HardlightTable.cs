...
namespace SOTS.Items.Planetarium.Furniture
{
	public class HardlightTable : ModItem
	{
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableBase").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableMiniOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableMiniFill").Value;
	...
	public class HardlightTableTile : ModTile
	{
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableTileGlow").Value;
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			if (Main.tile[i, j].TileFrameX < 18 || Main.tile[i, j].TileFrameX > 35 || Main.tile[i, j].TileFrameY % 36 < 18)
				return true;
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightTableFill").Value;
			Color color;
			color = WorldGen.paintColor((int)Main.tile[i, j].TileColor) * (100f / 255f);
			color.A = 0;
			Vector2 zero = new Vector2(Main.offScreenRange, Main.offScreenRange);
