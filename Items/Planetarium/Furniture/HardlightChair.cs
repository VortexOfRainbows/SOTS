...
namespace SOTS.Items.Planetarium.Furniture
{
	public class HardlightChair : ModItem
	{
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightChairBase").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightChairOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightChairFill").Value;
	...
	public class HardlightChairTile : Items.Furniture.Chair<HardlightChair>
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightChairTileGlow").Value;
