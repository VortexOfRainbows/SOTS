...
namespace SOTS.Items.Planetarium.Furniture
{
	public class PotGenerator : ModItem
	{
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/PotGeneratorBase").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/PotGeneratorMiniOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/PotGeneratorMiniFill").Value;
	...
	public class PotGeneratorTile : ModTile
	{
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/PotGeneratorTileGlow").Value;
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if (Main.tile[i, j].TileFrameX >= 18)
				return true;
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/SkyPotsGlowOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/SkyPotsGlowFill").Value;
			Color color;
			color = WorldGen.paintColor((int)Main.tile[i, j].TileColor) * (100f / 255f);
			color.A = 0;
			Vector2 zero = new Vector2(Main.offScreenRange, Main.offScreenRange);
