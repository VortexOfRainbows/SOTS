...
namespace SOTS.Items.Planetarium.Furniture
{
	public class HardlightFabricator : ModItem
	{
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightFabricatorBase").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightGearMiniBorder").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightGearMiniFill").Value;
	...
	public class HardlightFabricatorTile : ModTile
	{
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightFabricatorTileGlow").Value;
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if(Main.tile[i, j].TileFrameX >= 36 && Main.tile[i, j].TileFrameY % 36 >= 18)
				type = 3;
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightGearBorder").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/HardlightGearFill").Value;
			Color color;
			color = WorldGen.paintColor((int)Main.tile[i, j].TileColor) * (100f / 255f);
			color.A = 0;
			Vector2 zero = new Vector2(Main.offScreenRange, Main.offScreenRange);
