...
namespace SOTS.Items.Planetarium.Furniture
{
	public class DigitalDisplay : ModItem
	{
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/DisplayItem").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/MiniDisplay1").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/MiniDisplayBackground").Value;
	...
	public class DigitalDisplayTile : ModTile
	{
		...
		public override bool PreDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			if (Main.tile[i, j].TileFrameX < 18 || Main.tile[i, j].TileFrameX > 35 || Main.tile[i, j].TileFrameY % 36 < 18)
				return true;
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/Display" + style).Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Furniture/DisplayBackground").Value;
			Color color;
