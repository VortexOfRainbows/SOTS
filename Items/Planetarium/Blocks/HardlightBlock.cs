...
namespace SOTS.Items.Planetarium.Blocks
{
	public class HardlightBlock : ModItem
	{
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/Blocks/HardlightBlockOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/Blocks/HardlightBlockFill").Value;
