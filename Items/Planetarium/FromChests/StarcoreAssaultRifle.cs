...
namespace SOTS.Items.Planetarium.FromChests
{
	public class StarcoreAssaultRifle : VoidItem
	{
		...
		public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/StarcoreAssaultRifleEffect").Value;
			for (int k = 0; k < 2; k++)
			...
			texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/StarcoreAssaultRifleEffect2").Value;
			for (int k = 0; k < 2; k++)
			...
			texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/StarcoreAssaultRifleEffect3").Value;
			for (int k = 0; k < 2; k++)
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
		{
			...
			texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/StarcoreAssaultRifleGlow").Value;
