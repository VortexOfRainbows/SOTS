...
namespace SOTS.Items.Planetarium.FromChests
{
	...
	{ 	
		...
		public override void SafeSetDefaults()
		{
			...
			if (!Main.dedServ)
			{
				Item.GetGlobalItem<ItemUseGlow>().glowTexture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/HardlightScytheGlow").Value;
			}
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/HardlightScytheGlow").Value;
