...
namespace SOTS.Items.Planetarium.FromChests
{
	public class SupernovaHammer : ModItem
	{
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/SupernovaHammerGlow").Value;
		...
		public override void SetDefaults()
		{
			...
			Item.autoReuse = true;
			Item.shoot = ModContent.ProjectileType<Projectiles.Planetarium.SupernovaHammer>();
			Item.shootSpeed = 24f;
			Item.noMelee = true;
