...
namespace SOTS.Items.Planetarium.FromChests
{
	...
	{ 	
		...
		public override void SetDefaults()
		{
			...
			if (!Main.dedServ)
			{
				Item.GetGlobalItem<ItemUseGlow>().glowTexture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/LashesOfLightningGlow").Value;
			}
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/LashesOfLightningGlow").Value;
