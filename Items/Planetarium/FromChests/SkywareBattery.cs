...
namespace SOTS.Items.Planetarium.FromChests
{
	...
	{	
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/SkywareBatteryGlow").Value;
			...
			texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/FromChests/SkywareBatteryEffect").Value;
