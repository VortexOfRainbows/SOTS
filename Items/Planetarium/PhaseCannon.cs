...
namespace SOTS.Items.Planetarium
{
	public class PhaseCannon : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			if (!Main.dedServ)
			{
				Item.GetGlobalItem<ItemUseGlow>().glowTexture = Mod.Assets.Request<Texture2D>("Items/Planetarium/PhaseCannonGlow").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/PhaseCannonGlow").Value;
