...
namespace SOTS.Items.Planetarium
{
	...
	{	
		...
		{
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/BladeGeneratorBase").Value;
		...
		{
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Planetarium/BladeGeneratorOutline").Value;
			Texture2D texture2 = Mod.Assets.Request<Texture2D>("Items/Planetarium/BladeGeneratorFill").Value;
