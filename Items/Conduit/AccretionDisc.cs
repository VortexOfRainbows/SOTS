...
namespace SOTS.Items.Conduit
{
	public class AccretionDisc : VoidItem
	{
        ...
        {
            CreateRecipe(1).AddIngredient<CataclysmDisc>(1).AddIngredient<SkipSoul>(30).AddIngredient<SkipShard>(15).AddIngredient<DissolvingNether>(1).AddIngredient<SoulOfPlight>(20).AddTile(TileID.MythrilAnvil).Register();
        }
    }
}