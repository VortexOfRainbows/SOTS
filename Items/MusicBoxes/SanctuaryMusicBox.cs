...
{
	public class SanctuaryMusicBox : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<SanctuaryMusicBoxTile>();
			Item.width = 24;
			Item.height = 24;
        ...
        {
            CreateRecipe(1).AddIngredient<RunicEvostone>(10).AddIngredient<RunicEvostoneBrick>(10).AddIngredient<FragmentOfInferno>(10).AddIngredient(ItemID.MusicBox).AddTile(TileID.HeavyWorkBench).Register();
        }
    }
	public class SanctuaryMusicBoxTile : ModTile
    {
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            yield return new Item(ModContent.ItemType<SanctuaryMusicBox>());
        }
