...
{
	public class Cobalter : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalter");
			Tooltip.SetDefault("Syphons two bouncing bolts out of thin air");
		}
		public override void SetDefaults()
		{
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("Copulse"); 
            item.shootSpeed = 4;
			item.mana = 9;
			item.reuseDelay = 2;
