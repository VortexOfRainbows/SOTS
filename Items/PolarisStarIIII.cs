...
{
	public class PolarisStarIIII : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Spur I");
			Tooltip.SetDefault("Still not the final form");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "PolarisStarIII", 1);
