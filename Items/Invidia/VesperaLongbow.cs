...
namespace SOTS.Items.Invidia
{
	public class VesperaLongbow : VoidItem
	{
        ...
        {
			Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Projectiles.Earth.EvostoneLongbow>(), damage, knockback, player.whoAmI, (int)(Item.useTime / SOTSPlayer.ModPlayer(player).attackSpeedMod), type);
			return false;
		}
