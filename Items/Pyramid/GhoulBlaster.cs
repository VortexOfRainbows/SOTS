		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
				...
				if(shotNum == 5)
				{
					...
					if(shotNum >= 6)
					{
						...
						shotNum = 0;
						Projectile.NewProjectile(position.X, position.Y, speedX * 0.9f, speedY * 0.9f, mod.ProjectileType("CurseSingularity"), (int)(damage * 2f), knockBack, player.whoAmI);
						return false;
					}
