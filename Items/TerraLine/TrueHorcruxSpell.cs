...
{
	public class TrueHorcruxSpell : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Horcrux Spell");
			Tooltip.SetDefault("Summons a ball of pure evil on your cursor");
		}
		public override void SetDefaults()
		{
            item.damage = 54;  //gun damage
            ...
            item.autoReuse = true;
            item.shoot =  mod.ProjectileType("ShadowStrong"); 
            item.shootSpeed = 24;
			item.expert = true;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "HorcruxSpell", 1);
