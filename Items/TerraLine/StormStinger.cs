...
{
	public class StormStinger : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Storm Stinger");
			Tooltip.SetDefault("Fires your current bullets along with wasps\n33% chance to not consume ammo");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
          {
			  ...
			  Vector2 perturbedSpeed4 = new Vector2(speedX, speedY).RotatedByRandom(MathHelper.ToRadians(24)); // This defines the projectiles random spread . 30 degree spread.
                  ...
                  Projectile.NewProjectile(position.X, position.Y, perturbedSpeed2.X, perturbedSpeed2.Y, 189, damage, knockBack, player.whoAmI);
                  Projectile.NewProjectile(position.X, position.Y, perturbedSpeed4.X, perturbedSpeed4.Y, 189, damage, knockBack, player.whoAmI);
