...
{
	public class IraGateway : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<IraGatewayTile>();
		}
	}	
	public class IraGatewayTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			AddMapEntry(new Color(35, 110, 0), Language.GetText("Mods.SOTS.Tiles.GatewayTile.MapEntry"));
		...
		public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
		{
			...
			Texture2D texture = Mod.Assets.Request<Texture2D>("Items/Temple/IraGatewayTileGlow").Value;
